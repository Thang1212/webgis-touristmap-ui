...
//   return (
//     <div className="absolute top-4 left-4 bg-white rounded-lg shadow-lg overflow-hidden z-10 transition-all duration-200 mt-10">
//       {/* === Header === */}
//       <button
//         onClick={() => setIsExpanded(!isExpanded)}
//         className={`flex items-center justify-between px-3 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 transition-all ${
...
//       {isExpanded && (
//         <>
//           <div className="max-h-[500px] overflow-y-auto p-3 space-y-2 w-[280px]">
//             {layers.map((layer) => {
...
//           {/* === Footer === */}
//           <div className="px-3 py-2 bg-gray-50 border-t border-gray-200 text-xs flex justify-between items-center w-[280px]">
