...
// // Default
// export const defaultIcon = createCustomIcon('#6b7280', '📍');        // Gray //this is the problem
...
//  * @returns L.DivIcon
//  */
// export const getIcon = (category: string): L.DivIcon => { //this is the problem
